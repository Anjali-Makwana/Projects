...
public class EmpHome {
	...
	public Emp findById(java.lang.Integer id) {
		...
		try {
			Emp instance = (Emp) sessionFactory.getCurrentSession().get("com.SpringCrud.entity.Emp", id);
			if (instance == null) {
	...
	public List findByExample(Emp instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.SpringCrud.entity.Emp")
