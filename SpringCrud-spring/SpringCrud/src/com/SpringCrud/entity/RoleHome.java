 ...
 * @see com.SpringCrud.entity.Role
...
public class RoleHome {
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) sessionFactory.getCurrentSession().get("com.SpringCrud.entity.Role", id);
			if (instance == null) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.SpringCrud.entity.Role")
