 ...
 * @see com.SpringCrud.entity.Login
...
public class LoginHome {
	...
	public Login findById(long id) {
		...
		try {
			Login instance = (Login) sessionFactory.getCurrentSession().get("com.SpringCrud.entity.Login", id);
			if (instance == null) {
	...
	public List findByExample(Login instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.SpringCrud.entity.Login")
